...
TrickOrBoom.Enemy = function (game_state, name, position, properties) {
    "use strict";
...
TrickOrBoom.Enemy.prototype = Object.create(TrickOrBoom.Prefab.prototype);
TrickOrBoom.Enemy.prototype.constructor = TrickOrBoom.Enemy;

TrickOrBoom.Enemy.prototype.update = function () {
    "use strict";
    var new_position;
...
TrickOrBoom.Enemy.prototype.switch_direction = function () {
    "use strict";
    if (this.axis === "x") {
